...
unsigned int ReductionMapBody::Hash(unsigned int modsize) const
{
...
unsigned int ReductionMapBody::Size() const {
...
unsigned int ReductionMapHandle::Hash(unsigned int modsize) const
{
  return ((unsigned int) reinterpret_cast<uintptr_t>(mapContents) >> 2) % modsize;
}

unsigned int ReductionMapHandle::Size() const
{
...
intpair ReductionMapHandle::Lookup(intpair& x) const
{
...
int ReductionMapHandle::Lookup(int x) const
{
...
int ReductionMapHandle::LookupInv(int y) const
{
